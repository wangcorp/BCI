...
%% Topoplot
f_top = figure;
p_top = uipanel('Parent',f_top,'BorderType','none'); 
p_top.Title = 'ERD/ERS'; 
...
subplot(2,3,2,'Parent',p_top);
title('"Both hands" - Laplacian filtering');
...
subplot(2,3,4,'Parent',p_top)
title('"Both feet" - CAR filtering');
...
subplot(2,3,5,'Parent',p_top)
title('"Both feet" - Laplacian filtering');
...
subplot(2,3,3,'Parent',p_top)
title('"Both hands" - No filter');
...
subplot(2,3,6,'Parent',p_top)
title('"Both feet" - No filter');
